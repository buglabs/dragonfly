...
public class GeneratorActivator {
	...
	protected final String TEXT_4 = " implements BundleActivator {" + NL + "" + NL + "\tpublic void start(BundleContext context) throws Exception {" + NL
			+ "\t\t// TODO Auto-generated method stub" + NL + "\t\t" + NL + "\t}" + NL + "" + NL + "\tpublic void stop(BundleContext context) throws Exception {" + NL
			+ "\t\t// TODO Auto-generated method stub" + NL + "\t\t" + NL + "\t}" + NL + "}";
