 ...
 * 
 * It keeps tracks of all the possible values for a service and the current
 * selected or set value
 * 
 * @author bballantine
 * 
 */
public class ServicePropertyHelper {
	...
	public static List<ServicePropertyHelper> createHelperList(List<ServiceProperty> properties) {

		List<ServicePropertyHelper> helper = new ArrayList<ServicePropertyHelper>();
