...
public class ServiceTrackerCustomizer {
	...
	protected final String TEXT_2 = ";" + NL + "" + NL + "import org.osgi.framework.BundleContext;" + NL + "import com.buglabs.application.AbstractServiceTracker;" + NL;
	...
	protected final String TEXT_10 = "ServiceTracker(BundleContext context) {" + NL + "\t\tsuper(context);" + NL + "\t}" + NL + "\t" + NL + "\t/**" + NL
			+ "\t * Determines if the application can start." + NL + "\t */" + NL + "\tpublic boolean canStart() {" + NL + "\t\treturn super.canStart();" + NL + "\t}" + NL + "\t"
			+ NL + "\t/**" + NL + "\t * If canStart returns true" + NL + "     * this method is called to start the application." + NL + "     * Place your fun logic here. " + NL
			+ "\t */" + NL + "\tpublic void doStart() {";
	...
	protected final String TEXT_15 = NL + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * Called when a service that this application depends is unregistered." + NL + "\t */"
			+ NL + "\tpublic void doStop() {";
	...
	protected final String TEXT_19 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * Allows the user to set the service dependencies by" + NL
			+ "     * adding them to services list returned by getServices()." + NL + "     * i.e.nl getServices().add(MyService.class.getName());" + NL + "\t */" + NL
	...
	private String createServiceFilterArrayDefinition(Map properties) {
		...
		while (itr.hasNext()) {
			...
			serviceFilterArrayDef += delim + "{\"" + propKey + "\", \"" + properties.get(propKey) + "\"}";
			delim = ", ";
		}
	...
	public String generate(List serviceNames, Map propertyMap, String appName, String packageName, String appPackageName, boolean genApp, boolean usesPropertyFilters) {
		...
		if (genApp && !usesPropertyFilters) {
			...
			while (si.hasNext()) {
				...
				if (propertyMap.containsKey(name)) {
					serviceFilterArrayDef = createServiceFilterArrayDefinition((Map) propertyMap.get(name));
				}
