...
public class ServiceTrackerCustomizer {
	...
	protected final String TEXT_5 = NL + NL + " /**" + NL + " *\tService tracker for the BugApp Bundle;" + NL + " *" + NL + " */" + NL
			+ "public class ";
	...
	protected final String TEXT_10 = "ServiceTracker(BundleContext context) {" + NL + "\t\tsuper(context);" + NL + "\t}" + NL + "\t" + NL
			+ "\t/**" + NL + "\t * Determines if the application can start." + NL + "\t */" + NL + "\tpublic boolean canStart() {" + NL
			+ "\t\treturn super.canStart();" + NL + "\t}" + NL + "\t" + NL + "\t/**" + NL + "\t * If canStart returns true" + NL
			+ "     * this method is called to start the application." + NL + "     * Place your fun logic here. " + NL + "\t */" + NL
			+ "\tpublic void doStart() {";

	protected final String TEXT_11 = NL + "\t\tif(!getApplication().isAlive()) {" + NL + "\t\t\tif(getApplication().getRan()) {" + NL
			+ "\t\t\t\tapplication = new ";
	...
	protected final String TEXT_15 = NL + NL + "\t}" + NL + "" + NL + "\t/**" + NL
			+ "\t * Called when a service that this application depends is unregistered." + NL + "\t */" + NL + "\tpublic void doStop() {";
	...
	protected final String TEXT_19 = NL + NL + "\t}" + NL + "" + NL + "\t/**" + NL
			+ "\t * Allows the user to set the service dependencies by" + NL
			+ "     * adding them to services list returned by getServices()." + NL
			+ "     * i.e.nl getServices().add(MyService.class.getName());" + NL + "\t */" + NL + "\tpublic void initServices() {";
	...
	protected final String TEXT_25 = "Application getApplication() {" + NL + "\t\tif(application == null) {" + NL
			+ "\t\t\tapplication = new ";
