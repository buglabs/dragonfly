...
public class Activator {
	...
	protected final String TEXT_3 = ".*;" + NL + "import com.buglabs.util.ServiceFilterGenerator;" + NL + "import org.osgi.framework.BundleActivator;" + NL
			+ "import org.osgi.framework.BundleContext;" + NL + "import org.osgi.framework.Filter;" + NL + "import org.osgi.util.tracker.ServiceTracker;" + NL + "" + NL + "/**"
			+ NL + " * BundleActivator for ";
	protected final String TEXT_4 = "." + NL + " *" + NL + " */" + NL + "public class Activator implements BundleActivator {" + NL + "\tprivate ";
	protected final String TEXT_5 = "ServiceTracker stc;" + NL + "\tprivate ServiceTracker st;" + NL + "\t/*" + NL + "\t * (non-Javadoc)" + NL
			+ "\t * @see org.osgi.framework.BundleActivator#start(org.osgi.framework.BundleContext)" + NL + "\t */" + NL
			+ "\tpublic void start(BundleContext context) throws Exception {\t\t" + NL + "\t\t//Create the service tracker and run it." + NL + "\t\tstc = new ";
	...
	protected final String TEXT_9 = NL + "\t\tst = new ServiceTracker(context, f, stc);" + NL + "\t\tst.open();" + NL + "\t}" + NL + "" + NL + "\t/*" + NL + "\t * (non-Javadoc)"
			+ NL + "\t * @see org.osgi.framework.BundleActivator#stop(org.osgi.framework.BundleContext)" + NL + "\t */" + NL
			+ "\tpublic void stop(BundleContext context) throws Exception {" + NL + "\t\tstc.stop();" + NL + "\t\tst.close();" + NL + "\t}" + NL + "}";
