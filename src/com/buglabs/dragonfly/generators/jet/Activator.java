...
public class Activator
 {
  ...
  protected final String TEXT_8 = NL + NL + "import org.osgi.framework.BundleActivator;" + NL + "import org.osgi.framework.BundleContext;" + NL + "import org.osgi.util.tracker.ServiceTracker;" + NL + "" + NL + "import com.buglabs.application.ServiceTrackerHelper;" + NL;
  protected final String TEXT_9 = NL + "import org.osgi.service.log.LogService;\t\t" + NL + "import com.buglabs.util.LogServiceUtil;";
  ...
  protected final String TEXT_18 = NL + "\t\tserviceTracker = ServiceTrackerHelper.openServiceTracker(context, services, new ServiceTrackerHelper.ManagedInlineRunnable() {" + NL + "\t\t\t" + NL + "\t\t\t@Override" + NL + "\t\t\tpublic void run(Map<Object, Object> services) {";
  ...
  protected final String TEXT_25 = NL + "\t\t//Begin tracking services, and when all services are available, create thread and call ManagedRunnable.run()." + NL + "\t\tserviceTracker = ServiceTrackerHelper.openServiceTracker(context, services, new ";
  ...
  protected final String TEXT_33 = NL + "\t\tserviceTracker = ServiceTrackerHelper.openServiceTracker(context, getServiceNames(serviceMap), createFilter(context, serviceMap), new ServiceTrackerHelper.ManagedInlineRunnable() {" + NL + "\t\t\t" + NL + "\t\t\t@Override" + NL + "\t\t\tpublic void run(Map<Object, Object> services) {";
  ...
  protected final String TEXT_40 = NL + "\t\t//Begin tracking services, and when all services are available, create thread and call ManagedRunnable.run()." + NL + "\t\tserviceTracker = ServiceTrackerHelper.openServiceTracker(context, getServiceNames(serviceMap), createFilter(context, serviceMap), new ";
