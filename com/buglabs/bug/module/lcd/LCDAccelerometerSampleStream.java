...
public class LCDAccelerometerSampleStream extends AccelerometerSampleStream implements IAccelerometerConfigurationListener{
	
	private AccelerometerConfiguration config;
	private AccelerometerControl accControl;
	private BufferedReader buffer;

	public LCDAccelerometerSampleStream(InputStream is, AccelerometerControl accControl) {
		super(is);
